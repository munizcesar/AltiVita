...
> **Hub de Inteligência Tecnológica para o Brasil**
...
- **Altura mínima:** 24px (digital) / 10mm (impresso)
- **Área de respiro:** 1x a altura da letra em todos os lados
- **Proporção:** Manter aspect ratio sempre
...
**Logo:**
- "Alti": Inter SemiBold (600)
- "Vita": Inter Bold (700)

**Conteúdo:**
- **Títulos H1:** Inter Bold (700) ou ExtraBold (800)
- **Títulos H2-H3:** Inter SemiBold (600)
- **Títulos H4-H6:** Inter Medium (500)
- **Corpo de texto:** Inter Regular (400)
- **Texto secundário:** Inter Regular (400) com opacity reduzida
- **Botões:** Inter SemiBold (600)
- **Badges:** Inter Bold (700)
...
**Para Código/Specs:** JetBrains Mono ou Fira Code
...
| Cor | Hex | RGB | Uso |
|-----|-----|-----|-----|
| **Texto Escuro** | `#1F2937` | 31, 41, 55 | Texto principal |
| **Texto Médio** | `#6B7280` | 107, 114, 128 | Texto secundário |
| **Branco** | `#FFFFFF` | 255, 255, 255 | Background |
| **Cinza Claro BG** | `#F9FAFB` | 249, 250, 251 | Background alternativo |

Ver [COLOR-GUIDE.md](./COLOR-GUIDE.md) para paleta completa e diretrizes de uso.
...
**Estilo:**
- **Outline icons** preferencialmente
- Peso de linha consistente (2px)
...
**Estilo de Fotos de Produtos:**
- Fundo branco limpo ou contextuais
- Alta resolução (mínimo 1200px largura)
...
- Include palavra-chave principal
- Máximo 60 caracteres (SEO)

**Exemplos:**
- ✅ "Melhor Notebook 2026: Top 10 Opções para Comprar"
- ✅ "Review Dell Inspiron 15: Vale a Pena em 2026?"
- ❌ "Você Não Vai Acreditar Neste Notebook!" (clickbait)
...
- Parágrafos pequenos (3-4 linhas)
...
**Documentação:**
- [COLOR-GUIDE.md](./COLOR-GUIDE.md) - Guia completo de cores
- [CONTENT-GUIDE.md](./CONTENT-GUIDE.md) - Diretrizes de conteúdo
- [BRAZIL_STRATEGY.md](./BRAZIL_STRATEGY.md) - Estratégia Brasil
...
**Contato:**
Para uso da marca: contato@altivita.com.br
